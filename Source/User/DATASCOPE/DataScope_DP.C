...
void DataScope_SendData(float Pitch,float Roll,float Yaw,float Accel_x,float Accel_y,float Accel_z,float Gyro_x,float Gyro_y,float Gyro_z)
{
		...
		DataScope_Get_Channel_Data(Accel_x , 4 );
		DataScope_Get_Channel_Data(Accel_y, 5 );
		DataScope_Get_Channel_Data(Accel_z , 6 );
		DataScope_Get_Channel_Data(Gyro_x, 7 );
		DataScope_Get_Channel_Data(Gyro_y, 8 );
		DataScope_Get_Channel_Data(Gyro_z, 9 );
